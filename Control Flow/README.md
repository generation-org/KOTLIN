...
1. Using IntelliJ, write a Kotlin app that takes numerical input from a user
2. The app should calculate sales reps commission based on this chart used by the retail store.
